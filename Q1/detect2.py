...
def detect(save_img=False):
    ...
    color_codes = {'blue': [255, 0, 0], 'green': [0, 255, 0], 'red': [0, 0, 255], 
                   'vline': [0, 0, 0], 'white': [255, 255, 255], 'yellow': [0, 255, 255]}
    colors = [color_codes[name] for name in names]
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                distance_file.write("_______________________\n\n")
                distance_file.close()
